...
int main(int argc, char **argv){
  ...
  desired_poseA.link_name = "l_wrist_roll_link";
  ...
  desired_poseB.link_name = "l_wrist_roll_link";
  ...
  goalC.motion_plan_request.group_name = "left_arm";
  ...
  desired_poseC.link_name = "l_wrist_roll_link";
